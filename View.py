...
if __name__ == '__main__':
    ...
    # transf = SpectralEmbedding(n_components=3, n_neighbors=25)
    ...
    # plt.scatter(fdata[:, 0], fdata[:, 1], zs=fdata[:, 2], depthshade=False, s=100, c=y)
    plt.scatter(fdata[:, 0], fdata[:, 1], c=y)
